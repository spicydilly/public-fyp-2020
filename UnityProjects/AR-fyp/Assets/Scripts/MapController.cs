...
{ 
    ...
    public void Btn360Selected ( )
    {
        ...
        // send url to console to manage selection, returns true if accepted
        //if (consoleController.GetComponent<ConsoleController>().MapPlacePortalButton(image360URL, textName.text))
        //{
        //    //portal can now be placed
        //}
    }

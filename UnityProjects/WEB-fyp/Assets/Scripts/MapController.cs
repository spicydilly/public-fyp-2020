...
public class MapController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //load the chosen maps json data
    ...
    // pass in the game object (its name is a unique ID) which was selected and decide what to do
    ...
    {
        // send url to the console to handle
        consoleController.Btn360MapHelper(image360URL);
    }
    ...
    private IEnumerator LoadMapJson( int mapJsonID )
    {
        ...
        {
            //setting a default user-agent in the header, without this the webhost will return 403 forbidden error, web build doesn't have this issue over custom set .htaccess file
